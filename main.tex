...
To get a first look at how relationships might have changed, we fitted separate simple linear regression models for different 5-year periods, specified as follows:
\begin{equation*}
\text{WinRate} = \beta_0 + \beta_1 \times \text{3P\%} + \beta_2 \times \text{2P\%} + \beta_3 \times \text{3P\_ratio} + \epsilon
\end{equation*}
We focus here on comparing the earliest period (2020-2024). Figure \ref{fig:period_models} displays the summary outputs for these two models.
...
\begin{align*}
WinRate ={}& \beta_0 + \beta_1 3P\% + \beta_2 2P\% + \beta_3 3P_ratio + \beta_4 2P_ratio + \beta_5 Era \\
&+ \beta_6 (3P\% \times Era) + \beta_7 (2P\% \times Era) + \beta_8 (3P_ratio \times Era) \\
&+ \beta_9 (2P_ratio \times Era) + \epsilon. 
\end{align*}
